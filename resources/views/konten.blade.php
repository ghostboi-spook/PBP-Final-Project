...
<head>
    ...
    <script src="{{ asset('js/konten.js') }}"></script>
</head>

<body class="bg-black text-white">

    <div class="max-w-5xl mx-auto px-3 sm:px-4 mt-4 mb-4">
    ...
    <div class="max-w-5xl mx-auto px-3 sm:px-4">
        ...
        <div class="flex flex-col sm:grid sm:grid-cols-[140px_1fr] lg:grid-cols-[180px_1fr_200px] gap-4 sm:gap-3 items-start mb-4">

            <div class="rounded-lg overflow-hidden bg-neutral-800 h-48 sm:h-56 w-32 sm:w-full mx-auto sm:mx-0 flex-shrink-0">
            ...
            <div class="hidden sm:block rounded-lg bg-neutral-800 overflow-hidden relative h-56">
            ...
            <div class="w-full sm:w-auto flex flex-col gap-2">
                <form action="{{ route('watchlist.toggle', $movie) }}" method="POST">
                    @csrf
                    <button
                        class="w-full sm:w-auto bg-[var(--imdb-yellow)] text-neutral-900 font-bold px-4 py-2.5 rounded-lg shadow hover:brightness-110 transition text-sm">
                ...
                @if ($movie->trailer_url)
                    <a href="{{ $movie->trailer_url }}" target="_blank"
                        class="sm:hidden w-full text-center bg-neutral-800 text-white px-4 py-2.5 rounded-lg text-sm hover:bg-neutral-700 transition">
                        ▶ Trailer
                    </a>
                @endif
            </div>
