        ...
        <section class="header-wrap bg-[#0d0d0d] border border-neutral-800 rounded-lg p-6 mb-6">
            <div>
                ...
                <p class="text-neutral-400 mt-2 max-w-xl">
                    Your Watchlist is the place to track the titles you want to watch. You can sort, reorder, and manage your list here.
                </p>
                <p class="text-sm text-neutral-400 mt-3">by <span class="text-blue-400">rizqi-0</span> • Created 2 minutes ago • Modified 43 seconds ago</p>
            </div>
        </section>
                ...
                <div class="flex items-center justify-between gap-4">
                    <div class="flex items-center gap-4">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <select id="sortSelect" class="bg-[#0b0b0b] border border-neutral-800 text-sm rounded px-3 py-2 focus:outline-none focus:ring-1 focus:ring-blue-500">
                    ...
                    <!-- Edit Button -->
                    <div>
                        <button id="editBtn" class="edit-btn px-4 py-2 rounded text-neutral-200 border border-neutral-800 bg-transparent hover:bg-neutral-900 transition-colors">
                            Edit
                        </button>
                    </div>
                </div>
